...
HPO_EXPERIMENT_NAME = "random-forest-hyperopt-hw2" # random-forest-hyperopt deleted ny accident :/
EXPERIMENT_NAME = "random-forest-best-models-hw2"
...
def run(data_path, log_top):
    ...
    mlflow.register_model( model_uri, name="nyc-taxi-rf-regressor" )
